          ...
          <div className="services-details-items">
            ...
            <div className="d-grid colums-2 mt-50">
                  ...
                  <div className="accordion" id="faqAccordion">
                      ...
                      >
                        <div className="accordion-body">
                          <p>
                            ...
                            no indulgence diminution so discovered mr apartments
                            are off under folly death.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          <p>
                            Regularity appetite disposed me an at subjects an.
                            To no indulgence diminution so discovered mr
                            apartments are off under folly death.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          <p>
                            Permanent appetite disposed me an at subjects an. To
                            no indulgence diminution so discovered mr apartments
                            are off under folly death.
                          </p>
                        </div>
              ...
              <div className="item">
                <h2>What we do?</h2>
                <p>
                  Regular libero tempore, cum soluta nobis est elig endi optio
                  cumque nihil impedit quo minus id quod maxime placeat facere
                  possimus, omnis voluptas assumenda.
                </p>
                <p>
                  Momnis voluptas assumenda est, omnis dolor repelle ndus.
